...
namespace Parva.Infrastructure.Implementations.Repository.SystemData
{
    public class MySqlite  
    {
        ...
        private SQLiteConnectionStringBuilder sqliteConnstrBuilder = null;
      //      new SQLiteConnectionStringBuilder();
        ...
        public bool isCryt = true;

        #region Sqlite Init
        public MySqlite()
        {
            sqliteConnstrBuilder = new SQLiteConnectionStringBuilder(
        ...
        //    sqliteConnstrBuilder = new SQLiteConnectionStringBuilder(connStr);
        //    //sqliteConnstrBuilder.Uri = connStr;
        //    //sqliteConnectionString = connStr;
        //    isInit = false;
        //    isTrans = false;
        //}
